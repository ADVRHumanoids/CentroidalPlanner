...
public:
    ...
    /**
     * @brief Solve a NLP problem of centroidal statics
     * @param solution output solution
     * @return status from the optimization:
     *
     * return codes are in /usr/include/coin/IpReturnCodes_inc.h:
     ...
     *
     */
    int Solve(solver::Solution& solution);
